...
func (l *Lexer) readChar() {
	...
	// l.ch is the current character
	// If we've read past the end of the input string, set l.ch to 0
	// Otherwise, set l.ch to the next character in the input string
	// Then, update l.position to be l.readPosition and increment l.readPosition by 1
	if l.readPosition >= len(l.input) {
		// ASCII code for the "NUL" character and signifies either
...
/*
newToken creates a new token.Token with the given type and character
*/
...
// peekChar peeks at the next character without advancing the lexer's position
